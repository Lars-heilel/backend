...
import { WS_SESSION_INTERFACE, WsSessionInterface } from './interface/wsSessionRepoInterface';

@Injectable()
export class SessionService implements SessionServiceInterface {
    private readonly logger = new Logger(SessionService.name);

    constructor(@Inject(WS_SESSION_INTERFACE) private sessionRepo: WsSessionInterface) {}
